...
<p className="prata1-1 lg:text-[16px]  text-[14px] max-w-[460px] ">Minerals left by volcanic ash, pure water flowing through<br className="lg:flex hidden"></br> layered earth, and wild botanicals nurtured in silence—<br className="lg:flex hidden"></br>each element is a product of time and nature’s refinement.</p>
