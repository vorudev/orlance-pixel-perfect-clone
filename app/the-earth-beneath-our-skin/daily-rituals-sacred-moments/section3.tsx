...
export const Section3grid = () => {
    ...
    return (
        <motion.div
                            ...
                            >
        <Link href="/the-earth-beneath-our-skin/light-captured-in-a-bottle" className="bg-[rgb(251,251,239)] text-[rgb(35,25,22)] w-full flex justify-center  ">
...
<div className="relative w-[180px] h-[252px] lg:w-[250px] lg:h-[350px] overflow-hidden">
    <Image src="/grid2web.webp"  fill alt=""  className=" aspect-[1/1.4] w-[180px] h-[252px] lg:w-[250px] lg:h-[350px] object-cover group-hover:scale-103 transition duration-500"></Image>
</div>
...
<p className="text-[13px] lg:text-[14px] prata6 text-center">
    Light reveals, but it also remembers.
</p>
