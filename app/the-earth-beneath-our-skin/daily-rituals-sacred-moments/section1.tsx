...
<div className="flex flex-col gap-[24px] px-[40px] items-center lg:w-1/2 lg:h-full lg:justify-center relative">
    <h1 className="text-[28px] md:text-[32px] lg:text-[40px] uppercase prata3 text-center max-w-[400px] ">daily rituals, sacred moments</h1>
...
<div className="flex-col flex items-center lg:items-start lg:w-1/2 ">
    <div className="flex flex-row gap-[4px] ">
        ...
        <p className="uppercase bdog2 text-[11px] md:text-xs">lee jisoo</p>
        </div>
        <div className="flex flex-row gap-[4px]">
        <p className="uppercase bdog2 text-[11px] md:text-xs">photos:</p>
        <p className="uppercase bdog2 text-[11px] md:text-xs">alex kim</p>
        </div>
</div>
<p className="text-[13px] prata6 lg:w-1/2 lg:text-[14px]">Repetition is how we remember who we are.</p>
</div>
