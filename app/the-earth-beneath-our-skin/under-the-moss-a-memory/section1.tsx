...
<div className="flex flex-col gap-[24px] px-[40px] items-center lg:w-1/2 lg:h-full lg:justify-center relative">
    <h1 className="text-[28px] md:text-[32px] lg:text-[40px] uppercase prata3 text-center max-w-[400px] ">under the moss, a memory</h1>
...
<div className="flex-col flex items-center lg:items-start lg:w-1/2 ">
    <div className="flex flex-row gap-[4px] ">
        ...
        <p className="uppercase bdog2 text-[11px] md:text-xs">kazuki tanaka</p>
        </div>
        <div className="flex flex-row gap-[4px]">
        <p className="uppercase bdog2 text-[11px] md:text-xs">photos:</p>
        <p className="uppercase bdog2 text-[11px] md:text-xs">hannah bae</p>
        </div>
</div>
<p className="text-[13px] prata6 lg:w-1/2 lg:text-[14px]">Moss doesn’t grow loudly—but it stays.</p>
</div>

</div>
<div className="relative aspect-[1/1.15] w-full mt-[24px] lg:mt-0 lg:w-1/2 lg:aspect-auto">
    <Image fill alt="" src="/grid4web.webp" className="aspect-[1/1.15] lg:aspect-auto object-cover "></Image>
</div>
</div>
        </div>
        </motion.div>
