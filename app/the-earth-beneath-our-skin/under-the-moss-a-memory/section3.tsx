...
export const Section3grid = () => {
    ...
    return (
        <motion.div
                            ...
                            >
        <Link href="/the-earth-beneath-our-skin/daily-rituals-sacred-moments" className="bg-[rgb(251,251,239)] text-[rgb(35,25,22)] w-full flex justify-center  ">
...
<div className="relative w-[180px] h-[252px] lg:w-[250px] lg:h-[350px] overflow-hidden">
    <Image src="/grid3.jpg" fill alt="" className=" aspect-[1/1.4] w-[180px] h-[252px] lg:w-[250px] lg:h-[350px] object-cover group-hover:scale-103 transition duration-500"></Image>
</div>
...
<h1 className="text-[20px] md:text-[22px] lg:text-[24px] prata7 uppercase text-center lg:max-w-[380px] md:max-w-[353.328px] "> 
    Daily Rituals, Sacred Moments
</h1>
<p className="text-[13px] lg:text-[14px] prata6 text-center">
    Repetition is how we remember who we are.
</p>
