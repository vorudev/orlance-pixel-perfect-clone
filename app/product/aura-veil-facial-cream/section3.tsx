...
export const Section3Item = () => {
    ...
    return ( 
        ...
        <div className="bg-[rgb(251,251,239)] text-[rgb(228,224,212)] w-full flex flex-col lg:flex-row ">
            ...
            <img src="/item4-hover.png" className="lg:aspect-[1/1.35] aspect-[1/1.15] object-cover"></img></div>
            <div className="   lg:w-1/2 aspect-[1/1.15] overflow-hidden bg-[rgb(43,28,19)]"> 
...
<img src="/itempage2.png" className="max-w-[100%]" ></img>
