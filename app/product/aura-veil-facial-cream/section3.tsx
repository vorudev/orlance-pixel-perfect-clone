...
export const Section3Item = () => {
    ...
    return ( 
        ...
        <div className="bg-[rgb(251,251,239)] text-[rgb(228,224,212)] w-full flex flex-col lg:flex-row ">
            <div className="lg:w-1/2 w-full lg:aspect-[1/1.35] aspect-[1/1.15] overflow-hidden relative">
            <Image alt='' fill src="/item4-hover-copy.webp" className=" object-cover"></Image></div>
            <div className="   lg:w-1/2 w-full aspect-[1/1.15] overflow-hidden bg-[rgb(43,28,19)]"> 
...
<img  alt='' src="/itempage2.webp" className="max-w-[100%]" ></img>
<div className="absolute bottom-[20px] px-[40px] lg:bottom-[48px]">
<p className="text-center text-[14px] md:text-[15px] lg:text-[16px] prata1-1 md:max-w-[380px]"> A veil-like cream that gently settles on the skin—sealing in moisture, light, and serenity.</p>
</div>
</div>
            </div>
        </div>
