...
<p className="text-[14px] md:text-[15px] lg:text-[16px] prata1-2 text-center max-w-[460px]">Jasmine extract soothes sensitive skin, while hyaluronic acid and ceramide complex strengthen its natural barrier. The result is lasting hydration, subtle radiance, and a comforting finish to your daily ritual.</p>
