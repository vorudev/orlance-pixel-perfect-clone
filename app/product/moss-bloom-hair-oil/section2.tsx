...
<p className="text-[14px] md:text-[15px] lg:text-[16px] prata1-2 text-center max-w-[460px]">Infused with clean moss oil and argan oil, this formula deeply hydrates and smooths the hair. Rosemary extract balances and soothes the scalp, supporting a healthier environment for growth.</p>
