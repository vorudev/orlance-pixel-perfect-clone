    ...
    return ( 
        ...
        <div className="bg-[rgb(251,251,239)] text-[rgb(228,224,212)] w-full flex flex-col lg:flex-row ">
            <div className="lg:w-1/2 overflow-hidden relative lg:aspect-[1/1.35] aspect-[1/1.15]">
                        <Image fill alt='' sizes="100vw" src="/item1-hoverfull.webp" className="lg:aspect-[1/1.35] aspect-[1/1.15] object-cover "></Image></div>
...
<img src="/itempage1.webp" className="max-w-[100%]" ></img>
