...
<p className="text-[13px] lg:text-[14px] lg:text-center  prata6 ">
 A clarifying toning serum that brings radiant clarity to the skin—like light drifting over a dawn-lit pond.
</p>
<p className="uppercase text-[11px] md:text-xs bdog1 ">$ 140.00 usd</p>
            </div>
