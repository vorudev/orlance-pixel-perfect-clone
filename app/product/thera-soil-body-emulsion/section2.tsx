...
<p className="text-[14px] md:text-[15px] lg:text-[16px] prata1-2 text-center max-w-[460px]">Shea butter and cocoa seed oil envelop the skin in lasting moisture and softness. Moss extract calms the skin and aids in recovery from environmental stressors, offering restorative comfort.</p>
