...
export const Section3Item = () => {
    ...
    return ( 
        ...
        <div className="bg-[rgb(251,251,239)] text-[rgb(228,224,212)] w-full flex flex-col lg:flex-row ">
            ...
            <Image fill alt='' sizes="100vw" src="/item2-hoverfull.webp" className="lg:aspect-[1/1.35] aspect-[1/1.15] object-cover "></Image></div>
            <div className="   lg:w-1/2 aspect-[1/1.15] overflow-hidden bg-[rgb(138,96,59)]"> 
...
<img src="/itempage4.webp" className="max-w-[100%]" ></img>
<div className="absolute bottom-[20px] px-[40px] lg:bottom-[48px]">
<p className="text-center text-[14px] md:text-[15px] lg:text-[16px] prata1-1 md:max-w-[380px]"> A body emulsion infused with the warmth of the earth—moisturizing and grounding like freshly turned soil.</p>
</div>
</div>
            </div>
        </div>
