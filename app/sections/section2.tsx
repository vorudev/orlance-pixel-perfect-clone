...
<h1 className="uppercase md:text-xs text-[11px] bdog2">material</h1>
<p className="prata1 lg:text-[16px] md:text-[15px] text-[14px] max-w-[460px] ">Minerals left by volcanic ash, pure water flowing through<br className="lg:flex hidden"></br> layered earth, and wild botanicals nurtured in silence—<br className="lg:flex hidden"></br>each element is a product of time and nature’s refinement.</p>
<Link href="/about" className="uppercase md:text-xs text-[11px] bdog2 flex-row flex items-center justify-center gap-2 cursor-pointer  group">
