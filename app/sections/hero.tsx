...
<img src="/bg.png" className=" h-screen w-full object-cover absolute"></img>
<div className="absolute w-full h-1/2 bg-gradient-to-b from-black/50 via-black/0 to-black/0 "></div>
<div className="relative w-full h-full flex justify-center items-center flex-col gap-[16px]">
    <h1 className="uppercase text-xs text-[rgb(228,224,212)] custext-ritual">into ritual</h1>
    <h1 className="uppercase text-[28px] text-[rgb(228,224,212)] prata3 text-center md:text-[32px] ">from the sacred<br></br>
soil of Arca</h1>
</div>
<div className="absolute w-full bottom-[20px]  "><h1 className="bot-text text-xs uppercase text-center  ">
...
<h1 className="bdog text-xs text-[#fff6] tracking-wider">© ORLANCE 2025</h1>
</div>
...
<div>
    <h1 className="bot-text text-xs uppercase text-center ">
